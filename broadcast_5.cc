...
//added from broadcast_6
 ...
 std::cout << "okay 4" << "\n" ;
  ...
  NetDeviceContainer ueDevs = wifi.Install (phy, mac, ueNodes);
   std::cout << "okay 21" << "\n" ;
 ...
 // generate call 
  ...
  ueAPttApp->SelectCall (0);
  ueBPttApp->SelectCall (0);
  std::cout << "okay 50" << "\n" ;
  ...
  //Simulator::Schedule (Seconds (5), &McpttTimer::Start);
  ...
  ueDevs.Get (1)->SetAttribute ("ReceiveErrorModel", PointerValue (em));
  */
